"""Page d'accueil — OPSIE x SISE 2026"""
...
| 🤖 **IA & ML** | Détection automatique de comportements suspects (algorithme Isolation Forest) et rapport de sécurité généré par intelligence artificielle (Mistral AI) |
""")

st.info(
    "💡 **Conseil de lecture** : utilisez les **filtres dans la barre latérale** (Protocole, Action) "
    "pour affiner l'analyse sur Dashboard, Données et IA & ML.",
    icon="🔍",
)
...
src_labels = {
    "mock":          ("🟡", "Données de démonstration",
                      ...
                      "Ils ne correspondent pas à un réseau réel — c'est la source utilisée par défaut pendant le développement."),
    "parquet":       ("🟢", "Fichier Parquet (logs réels OPSIE)",
                      "Les logs sont lus depuis un fichier Parquet contenant les données réelles du pare-feu OPSIE."),
